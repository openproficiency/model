...
An **Issuer** is an entity with credibility in a particular knowledge domain.

- An issuer may develop and modify a [topic list](topic-list.md).
- An issuer may provide [transcript entries](transcript-entry.md).

## Requirements to be an issuer

- Ownership of a domain name.
- Publicly shared certificate for enabling verification.
- Credibility, as perceived by the community.

> [!CAUTION]
> An individual may be their own issuer, for example during self-employment.
